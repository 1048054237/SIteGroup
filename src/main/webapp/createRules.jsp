...
<div class="container" id="content">
    ...
    <div id="entr">
        ...
        <ul id="ul3">
            <li>
                <p>
                    <span class="btn" onClick="add('category')">分类</span>
                </p>
            </li>
            <li>
                <p>
                    <span class="btn" onClick="add('size')">尺寸</span>
                </p>
            </li>
            <li>
                <p>
                    <span class="btn" onClick="add('style')">款式</span>
                </p>
            </li>
            <li>
                <p>
                    <span class="btn" onClick="add('color')">颜色</span>
                </p>
            </li>
